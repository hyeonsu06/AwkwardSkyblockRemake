...
import static io.hyonsu06.command.items.LoadItems.items;
import static io.hyonsu06.command.items.AllItemsPageInstance.getPage;

public class ShowAllItemsGUI {
    public static void open(Player p) {
        ...
        Inventory inv = Bukkit.getServer().createInventory(null, 54, "All Items");
        ...
        for (int i = 1; i < 45; i++) {
            ...
            try {
                inv.setItem(i + 8, items.get(index));
