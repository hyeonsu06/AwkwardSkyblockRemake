                ...
                if (!e.getPersistentDataContainer().has(getPDC("displayAdded"), PersistentDataType.BYTE)) {
                    ...
                    switch (event) {
                        case CreatureSpawnEvent ignored -> {
                            if (e.getWorld().getEnvironment().equals(World.Environment.NETHER)) {
                                if (e.getAttribute(Attribute.GENERIC_MAX_HEALTH) != null)
                                    e.getAttribute(Attribute.GENERIC_MAX_HEALTH).setBaseValue(e.getAttribute(Attribute.GENERIC_MAX_HEALTH).getBaseValue() * 40);
                                if (e.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE) != null)
                                    e.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE).setBaseValue(e.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE).getBaseValue() * 200);
                            }
                            if (e.getWorld().getEnvironment().equals(World.Environment.THE_END)) {
                                if (e.getAttribute(Attribute.GENERIC_MAX_HEALTH) != null)
                                    e.getAttribute(Attribute.GENERIC_MAX_HEALTH).setBaseValue(e.getAttribute(Attribute.GENERIC_MAX_HEALTH).getBaseValue() * 100);
                                if (e.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE) != null)
                                    e.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE).setBaseValue(e.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE).getBaseValue() * 500);
                            }
                            initEntity(e);
                            addDisplay(e);
                        }
                        case SpawnerSpawnEvent ignored -> {
                            ...
                            if (e.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE) != null)
                                e.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE).setBaseValue(e.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE).getBaseValue() * 50);
                            initEntity(e);
                            addDisplay(e);
                        }
                        case TrialSpawnerSpawnEvent ignored -> {
                            if (hasOminousTrialSpawner(getBlocksInRadius(e, 5))) {
                                ...
                                if (e.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE) != null)
                                    e.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE).setBaseValue(e.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE).getBaseValue() * 8000);
                                ...
                                if (e.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE) != null)
                                    e.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE).setBaseValue(e.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE).getBaseValue() * 100);
                            }
                            initEntity(e);
                            addDisplay(e);
                        }
